/* 
	...
	found at https://www.jqueryscript.net/animation/jQuery-Plugin-For-Scroll-triggered-Fade-In-Effect-fadeInElements-js.html
*/

$(document).ready(function() {
	$('.fade-scroll-bottom').fadeInElements();
});
(function ( $ ) {
